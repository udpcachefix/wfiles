...
echo Disabling RuntimeBroker
chdir /d C:\Windows\System32
ren RuntimeBroker.exe RuntimeBroker.old
taskkill /F /FI "IMAGENAME eq RuntimeBroker.exe"

echo Disabling Cortana
chdir /d C:\Windows\SystemApps\Microsoft.Windows.Cortana_cw5n1h2txyewy
ren SearchUI.exe SearchUI.old
taskkill /F /FI "IMAGENAME eq SearchUI.exe"
